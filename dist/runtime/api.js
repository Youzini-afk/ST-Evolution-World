import { getChatId, getChatMessages, getLastMessageId, } from "./compat/character";
import { getWorldbook, replaceWorldbook } from "./compat/worldbook";
import { validateEjsTemplate } from "./controller-renderer";
import { rederiveWorkflowAtFloor as rederiveWorkflowAtFloorRuntime, rerollCurrentAfterReplyWorkflow, } from "./events";
...
async function rollbackController() {
    try {
        ...
        const backupByEntryName = new Map(backup.controller_content.map((snapshot) => [
