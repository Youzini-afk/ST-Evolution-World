 ...
 */
export function writeExtensionSettings(data) {
    const ctx = getSTContext();
 ...
 */
export function onSTEvent(eventName, handler) {
 ...
 * 替代 `eventMakeFirst`。
 */
export function onSTEventFirst(eventName, handler) {
    const es = getEventSource();
...
//# sourceMappingURL=st-adapter.js.map