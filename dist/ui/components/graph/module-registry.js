...
const textIn = (id = 'text_in', label = '文本') => ({ id, label, direction: 'in', dataType: 'text' });
const textOut = (id = 'text_out', label = '文本') => ({ id, label, direction: 'out', dataType: 'text' });
const msgsIn = (id = 'msgs_in', label = '消息') => ({ id, label, direction: 'in', dataType: 'messages' });
const msgsOut = (id = 'msgs_out', label = '消息') => ({ id, label, direction: 'out', dataType: 'messages' });
const entriesIn = (id = 'entries_in', label = '条目') => ({ id, label, direction: 'in', dataType: 'entries' });
const entriesOut = (id = 'entries_out', label = '条目') => ({ id, label, direction: 'out', dataType: 'entries' });
const jsonIn = (id = 'json_in', label = 'JSON') => ({ id, label, direction: 'in', dataType: 'json' });
const jsonOut = (id = 'json_out', label = 'JSON') => ({ id, label, direction: 'out', dataType: 'json' });
// ════════════════════════════════════════════════════════════
// 🔌 Source — 数据源模块
// ════════════════════════════════════════════════════════════
...
export const MODULE_REGISTRY = new Map(ALL_MODULES.map(m => [m.moduleId, m]));
...
export function getAtomicModules() {
    return ALL_MODULES.filter(m => !m.isComposite);
}
/** Total module count */
